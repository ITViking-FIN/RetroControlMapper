...
1. Download `RetroControlMapper_v0.1.0_setup.exe` from the [latest release](https://github.com/ITViking-FIN/RetroControlMapper/releases/latest).
...
- **[Report a bug](https://github.com/ITViking-FIN/RetroControlMapper/issues)** — please include the version (`0.1.0`), your Windows version, and a description of what you expected versus what happened.
